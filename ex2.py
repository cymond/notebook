...
class HistClient(EClient):
    ...
    def get_IB_historical_data(self, ibcontract, durationStr="1 Y", barSizeSetting="1 day",
        ...
        historic_data.columns = ["Date", 'Open', 'High', 'Low', 'Settle', 'Volume']
...
class HistApp(HistWrapper, HistClient):
    def __init__(self, ipaddress, portid, clientid):
        HistWrapper.__init__(self)
        HistClient.__init__(self, wrapper=self)
